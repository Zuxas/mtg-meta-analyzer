...
- [ ] **M1 data-quality fix (gates board zone-counts + tap/counters/auras)** — `build_event_stream` game_num oscillation (dual-log pass) + sparse hand/lib/GY/exile zone tracking. See NEXT_STEPS.md. Foundational for the M-future Odds Engine.
